...
if [ ! $USER ]; then
  	echo "You must specify the userName used when starting vscodium1_62_3forcora1TempSetup"
else
cd vscodium1_62_3forcora1
...
${CONTAINERRUNTIME} run --rm -ti --privileged --ipc=host --env="QT_X11_NO_MITSHM=1"  -e DISPLAY=$DISPLAY \
 ...
 --name vscodium1_62_3forcora1TempSetup\
 vscodium1_62_3forcora1
 cd ../
fi
